...
[![Build](https://api.cirrus-ci.com/github/theo0r1z/theo-qt-helper.svg)](https://cirrus-ci.com/github/theo0r1z/theo-qt-helper)`n[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
...
**Theo Qt Helper** 是一款跨平台 **Qt 6 简体中�?API 文档** 离线阅读器，基于 Qt 6 �?CMake 构建。提供接�?Qt Assistant 的使用体验：目录、索引、全文检索、书签，以及多分栏标签页布局，便于对照阅读�?

| | |
|---|---|
| **仓库** | https://github.com/theo0r1z/theo-qt-helper |
| **预编译包** | �?Windows x64 �?[GitHub Releases](https://github.com/theo0r1z/theo-qt-helper/releases) |
| **本仓库内�?* | 仅应用程序源码（不含 `.qch` 文档包） |

### 界面截图

![主界�?�?导航、工具栏与文档阅读区](docs/screenshots/main-window.png)
...
3. 解压后运�?`TheoQtHelper.exe`�?

便携包内含程序、Qt 运行库及 `docs/qt-6.11/qt-zh.qhc` 中文帮助。需�?Windows 10/11 64 位；若无法启动，可运行包�?`vc_redist.x64.exe`�?

### 从源码构�?

支持�?**Windows**�?*Linux**�?*macOS** 上使�?CMake �?Qt 6.5+ 编译�?
...
| [Qt](https://www.qt.io/download) | 6.5+ �?Widgets、Help、PrintSupport、Network、Svg |
| [CMake](https://cmake.org/) | 3.21+ |
| C++ 工具�?| C++17 �?MSVC 2022、GCC 11+ �?Clang 14+ |
| [Ninja](https://ninja-build.org/) | 推荐 |

需自行准备 Qt Help 集合（`.qch` / `.qhc`）。Windows Release 中的中文文档�?*不在**本仓库内�?
...
Debian/Ubuntu 可安�?`qt6-base-dev`、`qt6-tools-dev`、`libqt6help6`、`libqt6svg6-dev`、`libqt6printsupport6` 等开发包�?
...
Qt®、Qt Assistant® 等为 The Qt Company Ltd. 的商标。Windows 发行包中的简体中文文档来源于 [doc.qt.io 中文版](https://doc.qt.io/qt-6/zh/)，仅�?API 签名等技术细节做了修正。详�?[docs/QT_DOC_NOTICE.md](docs/QT_DOC_NOTICE.md)�?
